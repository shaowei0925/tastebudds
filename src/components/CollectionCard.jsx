  ...
  return (
    <div className="flex flex-col px-16 py-16 gap-8">
      <CollectionCardRight
        ...
        subtitle="TasteBudds&#39; honey is 100% natural and unadulterated! We put our
    money where our mouth is with a 100% money-back guarantee."
        img="src\assets\pic4.png"
      />
      <CollectionCardLeft
        title="20-Second Meal"
        subtitle="Get your meal ready in just two steps. (Probably) The quickest meal you can make! Nutritious, tasty and convenient, what's not to love?"
        img="src\assets\pic3.png"
      />
      <CollectionCardRight
        title="Invest In Your Health"
        subtitle="Never miss your daily supplements again! Our Boosters are unflavoured and can be incorporated with any of your favourite food or drink."
        img="src\assets\pic2.png"
      />
      <CollectionCardLeft
        title="Modernized Tea"
        subtitle="Say goodbye to boring traditional tea bags and hello to our new and exciting tea sticks! Our tea sticks are perfect for on-the-go consumption."
