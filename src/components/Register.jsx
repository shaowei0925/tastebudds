      ...
      <form className="w-5/12 flex flex-col justify-center items-center">
        <div className="relative w-full mb-6 border border-yellow-900 rounded-3xl py-2 group hover:ring-1 hover:ring-yellow-900">
          <input
            ...
            required
          />
          <label className="px-4 absolute text-md text-yellow-900 duration-300 transform -translate-y-3 scale-75  top-4 peer-focus:scale-75 peer-focus:-translate-y-3 peer-placeholder-shown:scale-100 peer-placeholder-shown:font-normal peer-placeholder-shown:translate-y-0">
            First Name
          </label>
        </div>
        <div className="relative w-full mb-6 border border-yellow-900 rounded-3xl py-2 group hover:ring-1 hover:ring-yellow-900">
